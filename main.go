...
func FlyURL() string {
	return "https://arif-fajar-pangestu-final-project-be2794403-10.fly.dev" // TODO: replace this
}

func main() {
	wg := sync.WaitGroup{}
	os.Setenv("DATABASE_URL", "postgres://postgres:dewa1234@localhost:5432/kampusmerdeka")
